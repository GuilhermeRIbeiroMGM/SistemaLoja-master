...
namespace SistemaLoja.Controllers
{
    public class PessoaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustoimizarId,Nome,Sobrenome,Telefone,Endereco,Email,Documento,TipoDocumentoId")] Customizar customizar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustoimizarId,Nome,Sobrenome,Telefone,Endereco,Email,Documento,TipoDocumentoId")] Customizar customizar)
        {
            if (ModelState.IsValid)
            {
